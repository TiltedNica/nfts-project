...
<body class="bg-[#14141F] h-screen overflow-x-hidden">
<header class="pb-[59px] bg-red-[#14141F] relative h-[753px]">
    <img class="absolute z-0" src="{{asset('img/Graphic 2.svg')}}" alt="">
    <div class="h-[80px] border-b-2 border-b-gray-400  border-opacity-40 flex 2xl:justify-between justify-evenly items-center">
        <div class="2xl:ms-[255px]">
            ...
            @auth
                <div class="flex gap-x-4">
                    ...
                    <form action="{{route('logout')}}" method="post">
                        @csrf
                        <button
                            class=" 2xl:me-[268px] flex items-center gap-x-[8px] rounded-[34px] border border-[#5142FC] px-[33px] py-[14px] text-[15px] leading-[22px] text-white font-bold" type="submit">
                            Logout
                        </button>
                    </form>
                </div>
