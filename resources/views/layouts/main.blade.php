...
<header class="pb-[59px] h-[753px]">
    <img class="absolute" src="{{asset('img/Graphic 2.svg')}}" alt="">
    <div class="h-[80px] border-b-2 border-b-gray-400  border-opacity-40 flex justify-between items-center">
        ...
        <div class="flex gap-x-[36px] items-center">
            ...
            <button
                class="me-[268px] flex items-center gap-x-[8px] rounded-[34px] border border-[#5142FC] px-[33px] py-[14px]">
