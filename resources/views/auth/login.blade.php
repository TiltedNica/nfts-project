        ...
        <div class="flex flex-col gap-y-[43px]">
            ...
            <form class="flex flex-col gap-y-[24px]" action="{{route('login')}}" method="post" novalidate>
                ...
                <div class="flex flex-col gap-y-[24px]">
                    <input class="rounded-[8px] bg-transparent placeholder-[#8A8AA0] border border-[#343444] flex justify-center text-left w-[690px] ps-[20px] py-[13px] text-white"
                ...
                <div class="flex flex-col gap-y-[32px]">
                    <div class="flex justify-between">
                        ...
                        <div class="flex gap-2">
                            <a class="text-white" href="{{route('register')}}">Register Now</a>
                            <div class="text-white">|</div>
                            <a class="text-white" href="">Forgot Password?</a>
                        </div>
                    </div>
                    <button class="border-[2px] border-white rounded-[56px] w-[690px] h-[54px] flex items-center justify-center gap-x-[8px] text-white">
                        Login
                    </button>
                </div>
            </form>
